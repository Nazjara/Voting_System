...
public class MealServiceTestImpl extends AbstractServiceTest {
    ...
    public void testDelete() throws Exception {
        ...
        MATCHER.assertCollectionEquals(Arrays.asList(MEAL4, MEAL3, MEAL2), service.getAll(RESTAURANT1.getId()));
    }
    ...
    public void testSave() throws Exception {
        ...
        MATCHER.assertCollectionEquals(Arrays.asList(created, MEAL4, MEAL3, MEAL2, MEAL1), service.getAll(RESTAURANT1.getId()));
    }
    ...
    public void testUpdate() throws Exception {
        ...
        MATCHER.assertCollectionEquals(Arrays.asList(MEAL4, MEAL3, MEAL2, updated), service.getAll(RESTAURANT1.getId()));
    }
